        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CuisineType = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
                    BrandTone = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefreshTokenHash = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CallToAction = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
                    ImageModel = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    DeletedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    RestaurantId = table.Column<Guid>(type: "uuid", nullable: true),
                    OriginalPrompt = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                    EnhancedPrompt = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: false),
                    NegativePrompt = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_prompt_history", x => x.Id);
                    table.ForeignKey(
                        name: "FK_prompt_history_restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "restaurants",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_api_usage_users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GeneratedImageId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    DeletedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_generated_images_campaigns_CampaignId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_api_usage_UserId_Operation_CreatedAt",
                table: "api_usage",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_favorites_UserId_CampaignId_GeneratedImageId",
                table: "favorites",
                columns: new[] { "UserId", "CampaignId", "GeneratedImageId" });

            migrationBuilder.CreateIndex(
                name: "IX_generated_images_CampaignId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_prompt_history_RestaurantId",
